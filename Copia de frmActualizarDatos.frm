...
Private Sub GenerarPDFS(ByVal sRuta As String, ByVal idEmpr As Integer, ByVal sRutaDest As String)
    ...
    While Not rs.EOF
        ...
        sSQL = "Select * from Recibos_Tratamiento where Reg31_legajo = " & rs!Reg31_Legajo
...
'        cmd2.Parameters.Item(1).value = 0
'        cmd2.Parameters.Item(2).value = rsLega!Reg31_Legajo
'        cmd2.Parameters.Item(3).value = Replace(rsLega!Reg31_Cuil, "-", "")
'        cmd2.Parameters.Item(4).value = rsLega!Reg31_ApeNom
'        cmd2.Parameters.Item(5).value = rsLega!Reg31_Anio
'        cmd2.Parameters.Item(6).value = rsLega!Reg31_Mes
'        cmd2.Parameters.Item(7).value = rsLega!Reg01_TipoLiqCodigo
'        cmd2.Parameters.Item(8).value = rsLega!Reg01_TipoLiqDescripcion
'        cmd2.Parameters.Item(9).value = rsLega!Reg01_TipoLiqAbreviatura
'        cmd2.Parameters.Item(10).value = rsLega!Reg31_NroLiq
'        cmd2.Parameters.Item(11).value = rsLega!Reg01_FechaGen
'        cmd2.Parameters.Item(12).value = Date
'        cmd2.Parameters.Item(13).value = sRutaDest
'        cmd2.Parameters.Item(14).value = Trim(rsLega!Reg31_NombrePDF) & ".pdf"
'        cmd2.Parameters.Item(15).value = Date
'        cmd2.Parameters.Item(16).value = Date
'        cmd2.Parameters.Item(17).value = rs!Reg01_Empresa
'        cmd2.Execute
